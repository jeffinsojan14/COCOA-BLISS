...
SECRET_KEY = os.getenv('SECRET_KEY', 'cocoa-bliss-super-secret-key-for-college-project-2026')
...
if DB_ENGINE == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'cocoa_bliss'),
...
CORS_ALLOW_ALL_ORIGINS = True  # Facilitate local testing across multiple ports
